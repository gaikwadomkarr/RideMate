      ...
      builder: (BuildContext context, AsyncSnapshot<List<String>> snapshot) {
        if (!snapshot.hasData) {
          ...
          return ListView(
            ...
            children: List.generate(allPostsModel.data.length, (outerindex) {
              return Container(
                // height: 500,
                ...
                child: Column(children: <Widget>[
                    ...
                    children: <Widget>[
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                  ...
                                  margin: EdgeInsets.only(left: 10),
                                  child: new Text(
                                    allPostsModel.data[outerindex].likes.length
                                            .toString() +
                                        ' likes',
                            ...
                            Container(
                                ...
                                margin: EdgeInsets.only(left: 10),
                                child: new Text(
                                  allPostsModel.data[outerindex].comments.length
                                      .toString(),
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      fontSize: 15,
                      ...
                      Align(
                        ...
                        child: Container(
                            ...
                            child: new Text(
                              Jiffy(allPostsModel.data[outerindex].createdAt)
                                  .fromNow(),
                              textAlign: TextAlign.center,
                              style: TextStyle(
                  ...
                  Container(
                      ...
                      child: Text(title[outerindex], style: titleTxtStyle())),
                  Container(
                      alignment: Alignment.centerLeft,
                      margin: EdgeInsets.fromLTRB(20, 5, 10, 20),
                      child: Text(body[outerindex], style: bodyTxtStyle())),
                ]),
              );
            }),
          );
